...
import { X, TrendingUp, ChevronUp, ChevronDown, Users, Heart, Database } from 'lucide-react';
...
export default function ContributionPopup({ isOpen, onClose }: ContributionPopupProps) {
  ...
  return (
    ...
    >
      <div 
        ref={modalContentRef}
        className="bg-white rounded-[1.75rem] shadow-lift w-full max-w-7xl max-h-[90vh] flex flex-col overflow-hidden mx-2"
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-stone-100 flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="font-display font-bold tracking-tight text-lg text-ink">User Contributions</h2>
          </div>
          <button
            onClick={onClose}
          ...
          {error && (
            <div className="flex items-center justify-center h-32">
              <div className="text-center">
                <Users className="mx-auto text-stone-300 mb-2" size={24} />
              ...
              <div className="min-w-full overflow-x-auto">
                <table className="w-full border-collapse min-w-[500px]">
                  <thead className="sticky top-0 bg-stone-50 border-b border-stone-100">
                    <tr>
                      <th 
                        className="text-left p-2 sm:p-3 font-medium text-stone-500 text-sm cursor-pointer hover:bg-stone-100 transition-colors min-w-[120px]"
                      ...
                      <th 
                        className="text-center p-2 sm:p-3 font-medium text-stone-500 text-sm cursor-pointer hover:bg-stone-100 transition-colors min-w-[80px]"
                      ...
                      <th 
                        className="text-center p-2 sm:p-3 font-medium text-stone-500 text-sm cursor-pointer hover:bg-stone-100 transition-colors min-w-[70px]"
                        onClick={() => handleSort('likes')}
                      >
                        <div className="flex items-center justify-center gap-1">
                          <span className="hidden sm:inline">Likes</span>
                          <span className="sm:hidden"><Heart size={14} /></span>
                          {getSortIcon('likes')}
                        </div>
                      </th>
                    </tr>
                        ...
                        >
                          <td className="p-2 sm:p-3">
                            <div className="flex items-center gap-1 sm:gap-2">
                              ...
                              <span className="font-medium text-ink text-sm sm:text-base truncate">{contributor.name}</span>
                            </div>
                          </td>
                          <td className="p-2 sm:p-3 text-center text-stone-600 font-medium">
                            ...
                            <td colSpan={5} className="p-4">
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                <div className="bg-white p-3 rounded-xl border border-stone-100">
                                  <h4 className="font-semibold text-stone-600 mb-2">Movies</h4>
                                ...
                                <div className="bg-white p-3 rounded-xl border border-stone-100">
                                  <h4 className="font-semibold text-stone-600 mb-2">Restaurants</h4>
                                  <div className="space-y-1 text-stone-500">
                                ...
                                <div className="bg-white p-3 rounded-xl border border-stone-100">
                                  <h4 className="font-semibold text-stone-600 mb-2">Community</h4>
                                  <div className="space-y-1 text-stone-500">
        ...
        {!loading && !error && sortedContributors.length > 0 && (
          <div className="border-t border-stone-100 p-3 sm:p-4 flex-shrink-0">
