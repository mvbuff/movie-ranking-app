...
const SCORE_MAP: { score: number; display: string }[] = [
  ...
  { score: 7.5, display: 'CB-' },
  { score: 6.5, display: 'BB++' },
  { score: 5.5, display: 'BB+' },
  { score: 4.5, display: 'BB' },
  { score: 3.5, display: 'BB-' },
  { score: 2.5, display: 'AB++' },
  { score: 1.5, display: 'AB+' },
  { score: 0.5, display: 'AB' },
  { score: 0, display: 'AB-' },
];
